    ...
    : Entity
{
    ...
    public void RequestReturn(int units)
    {
        ...
        if (units > EligibleReturnUnits)
        {
            throw new OrderingDomainException($"Cannot return {units} unit(s) of '{ProductName}'. Only {EligibleReturnUnits} unit(s) are eligible for return.");
        }
